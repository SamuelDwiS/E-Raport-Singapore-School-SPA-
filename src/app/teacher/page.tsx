...
export default function TeacherDashboard() {
  ...
  const stats = [
    ...
    { label: "Total Subject", value: "18", color: "text-success-600 dark:text-success-400", bg: "bg-success-50 dark:bg-success-900/30" },
    { label: "Total Kelas", value: "6", color: "text-warning-600 dark:text-warning-400", bg: "bg-warning-50 dark:bg-warning-900/30" },
    { label: "Belum di nilai", value: "4", color: "text-error-600 dark:text-error-400", bg: "bg-error-50 dark:bg-error-900/30" },
  ];
